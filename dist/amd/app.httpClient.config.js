define(['exports', 'module', 'aurelia-http-client', 'isomorphic-fetch', './baseConfig', './authentication', './storage', 'aurelia-dependency-injection'], function (exports, module, _aureliaHttpClient, _isomorphicFetch, _baseConfig, _authentication, _storage, _aureliaDependencyInjection) {
  'use strict';
