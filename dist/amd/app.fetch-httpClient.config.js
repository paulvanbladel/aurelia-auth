define(['exports', 'module', 'aurelia-fetch-client', './authentication', './baseConfig', 'aurelia-framework', './storage'], function (exports, module, _aureliaFetchClient, _authentication, _baseConfig, _aureliaFramework, _storage) {
    'use strict';
