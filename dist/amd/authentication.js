                ...
                return {
                    request: function request(_request) {
                        if (auth.isAuthenticated() && config.httpInterceptor) {
                            ...
                            var accountId = window.localStorage.getItem("ni::account::id");
                            ...
                            if (accountId)
                                _request.headers.append('AccountId', accountId);
                    ...
                    response: function response(_response) {
                        if (!_response.ok && _response.status === 401) {
                            auth.logout("#" + auth.config.loginRoute);
                        }
                        return _response;
                    }
                };
